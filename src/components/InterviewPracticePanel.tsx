import { MockAnswerEvaluationPanel } from "@/components/MockAnswerEvaluationPanel";
...
export function InterviewPracticePanel({ locale, question, number, answer, submitting, error, evaluation, onAnswerChange, onSubmit, onBack }: { locale: SupportedLocale; question: Question; number: number; answer: string; submitting: boolean; error: string | null; evaluation: MockAnswerEvaluation | null; onAnswerChange: (answer: string) => void; onSubmit: () => void; onBack: () => void }) {
  return <section className="grid gap-6">
    ...
    {evaluation ? <MockAnswerEvaluationPanel locale={locale} evaluation={evaluation} /> : null}
  </section>;
}
