...
export function ResumeParseResult({ parsedResume, error }: ResumeParseResultProps) {
  ...
  if (error) {
    return (
      ...
      >
        <h2 className="text-base font-semibold">Resume parsing failed</h2>
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <dl className="mt-3 grid gap-2 text-sm text-zinc-700 sm:grid-cols-2">
            <div>
              <dt className="font-medium text-zinc-950">PDF file</dt>
              <dd className="break-words">{parsedResume.fileName}</dd>
            </div>
            <div>
              <dt className="font-medium text-zinc-950">Extracted characters</dt>
