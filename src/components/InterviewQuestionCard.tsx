...
export function InterviewQuestionCard({ locale, question, number, initiallyOpen }: { locale: SupportedLocale; question: Question; number: number; initiallyOpen: boolean }) {
